...
if FIT_tool:
   ...
   ipq_p_debug_dir = './ipq_p_debug'
   if not os.path.exists(ipq_p_debug_dir):
      os.makedirs(ipq_p_debug_dir,mode = 0755)

   ipq_s_debug_dir = './ipq_s_debug'
   if not os.path.exists(ipq_s_debug_dir):
      os.makedirs(ipq_s_debug_dir,mode = 0755)
   ...
   ipq_premium_flash_conf_file_debug_dir = './ipq_p_debug/ipq40xx_premium_debug'
   if not os.path.exists(ipq_premium_flash_conf_file_debug_dir):
      os.makedirs(ipq_premium_flash_conf_file_debug_dir,mode = 0755)
   ...
   ipq_standard_flash_conf_file_debug_dir = './ipq_s_debug/ipq40xx_standard_debug'
   if not os.path.exists(ipq_standard_flash_conf_file_debug_dir):
      os.makedirs(ipq_standard_flash_conf_file_debug_dir,mode = 0755)
   ...
   for flash_file in mi.get_files(attr='flash_file_debug'):
      shutil.copy(flash_file, ipq_p_debug_dir)
      shutil.copy(flash_file, ipq_s_debug_dir)

   for flash_file in mi.get_files(attr='flash_file_p_debug'):
      shutil.copy(flash_file, ipq_p_debug_dir)

   for flash_file in mi.get_files(attr='flash_file_s_debug'):
      shutil.copy(flash_file, ipq_s_debug_dir)
   ...
   # copy all files has attribute flash_premium_conf_debug_file to ipq_p_debug/ipq40xx_premium_debug folder
   for flash_premium_conf_debug_file in mi.get_files(attr='flash_premium_conf_debug_file'):
      shutil.copy(flash_premium_conf_debug_file, ipq_premium_flash_conf_file_debug_dir)
   ...
   # copy all files has attribute flash_standard_conf_debug_file to ipq_s_debug/ipq40xx_standard_debug folder
   for flash_standard_conf_debug_file in mi.get_files(attr='flash_standard_conf_debug_file'):
      shutil.copy(flash_standard_conf_debug_file, ipq_standard_flash_conf_file_debug_dir)
   ...
   for flash_premium_conf_file in mi.get_files(attr='flash_premium_conf_file'):
	  ...
	  # since this is premium build also copy all files has attribute flash_premium_conf_debug_file to ipq_p_debug_dir folder
   for flash_premium_conf_debug_file in mi.get_files(attr='flash_premium_conf_debug_file'):
      shutil.copy(flash_premium_conf_debug_file, ipq_p_debug_dir)

   for flash_premium_conf_debug_file in mi.get_files(attr='flash_premium_conf_debug_file'):
      shutil.copy(flash_premium_conf_debug_file, ipq_p_gcc5_dir)
  ...
  # copy all files has attribute QPST_file to uppermost meta folder
   ...
   ret_nornand_p_debug = 0
   ret_emmc_single = 0
   ret_emmc_p_debug = 0
   ret_norplusemmc_single = 0
   ret_norplusemmc_p_debug = 0
   ...
   ret_nand_p_debug = lg.log_exec(['python',pack_tool,'-t','nand','-B','-F','boardconfig_premium', '-o', bin_dir +'/'+'nand-ipq40xx-p-debug-single.img',ipq_p_debug_dir],verbose=0)
   print "ret_nand_p_debug %d." % ret_nand_p_debug
   ...
   ret_nor_p_debug = lg.log_exec(['python',pack_tool,'-t','nor','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'nor-ipq40xx-p-debug-single.img',ipq_p_debug_dir],verbose=0)
   print "ret_nor_p_debug %d." % ret_nor_p_debug
   ...
   ret_nornand_p_debug = lg.log_exec(['python',pack_tool,'-t','norplusnand','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'nornand-ipq40xx-p-debug-single.img',ipq_p_debug_dir],verbose=0)
   print "ret_nornand_p_debug %d." % ret_nornand_p_debug
   ...
   ret_emmc_p_debug = lg.log_exec(['python',pack_tool,'-t','emmc','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'emmc-ipq40xx-p-debug-single.img',ipq_p_debug_dir],verbose=0)
   print "ret_emmc_p_debug %d." % ret_emmc_p_debug
   ...
   ret_norplusemmc_p_debug = lg.log_exec(['python',pack_tool,'-t','norplusemmc','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'norplusemmc-ipq40xx-p-debug-single.img',ipq_p_debug_dir],verbose=0)
   print "ret_norplusemmc_p_debug %d." % ret_norplusemmc_p_debug
   ...
   # Streamboost3 binary generation for debug
   ret_streamboost_nor_debug = 0
   ret_streamboost_nand_debug = 0
   ret_streamboost_nornand_debug = 0

   if os.path.isfile("./ipq_p_debug/openwrt-ipq806x-streamboost3-squashfs-rootfs.img"):
		os.rename("./ipq_p_debug/openwrt-ipq806x-streamboost3-squashfs-rootfs.img", "./ipq_p_debug/openwrt-ipq806x-squashfs-root.img")
		os.rename("./ipq_p_debug/openwrt-ipq806x-ipq40xx-ubi-root-streamboost3-enabled.img", "./ipq_p_debug/openwrt-ipq806x-ipq40xx-ubi-root.img")
		ret_streamboost_nor_debug = lg.log_exec(['python',pack_tool,'-t','nor','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'nor-ipq40xx-debug-single-streamboost.img',ipq_p_debug_dir],verbose=0)
		print "ret_streamboost_nor_debug %d." % ret_streamboost_nor_debug
		ret_streamboost_nand_debug = lg.log_exec(['python',pack_tool,'-t','nand','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'nand-ipq40xx-debug-single-streamboost.img',ipq_p_debug_dir],verbose=0)
		print "ret_streamboost_nand_debug %d." % ret_streamboost_nand_debug
		ret_streamboost_nornand_debug = lg.log_exec(['python',pack_tool,'-t','norplusnand','-B', '-F','boardconfig_premium','-o', bin_dir +'/'+'nornand-ipq40xx-debug-single-streamboost.img',ipq_p_debug_dir],verbose=0)
		print "ret_streamboost_nornand_debug %d." % ret_streamboost_nornand_debug
		
   if ret_nand_single != 0 or ret_nand_p_debug != 0 or ret_nand_p_gcc5_single != 0 or ret_nor_single != 0 or ret_nor_p_gcc5_single != 0 or ret_nornand_single != 0 or ret_nornand_p_debug != 0 or ret_emmc_single != 0 or ret_emmc_p_debug != 0 or ret_norplusemmc_single != 0 or ret_norplusemmc_p_debug != 0 or ret_nor_apps != 0 or ret_nand_apps != 0 or ret_emmc_apps != 0 or ret_nornand_apps != 0 or ret_noremmc_apps != 0 or ret_streamboost_nor != 0 or ret_streamboost_nand != 0 or ret_streamboost_nornand != 0 or ret_streamboost_nand_debug != 0 or ret_streamboost_nornand_debug != 0:
