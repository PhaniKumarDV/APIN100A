...
/*===========================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.1/boot_images/core/storage/tools/emmcbld/src/bsp/emmcbld_bsp_scorpion.c#1 $ 
  $DateTime: 2014/09/09 14:47:07 $ 
  $Author: pwbldsvc $

YYYY-MM-DD   who     what, where, why
----------   ---     ----------------------------------------------------------
2010-07-16   rh      8660 bringup change
...
{
   HWIO_OUT(SCSS_WDT0_FRZ, HWIO_FMSK(SCSS_WDT0_FRZ, FRZ));
...
{
   uint32 count;
   HWIO_OUT(SCSS_GPT0_CNT, 0);
   HWIO_OUT(SCSS_GPT0_EN, 1);
   
   count = us * 0.032768;
   while (HWIO_IN(SCSS_GPT0_CNT) < count);
   HWIO_OUT(SCSS_GPT0_EN, 0);
}
