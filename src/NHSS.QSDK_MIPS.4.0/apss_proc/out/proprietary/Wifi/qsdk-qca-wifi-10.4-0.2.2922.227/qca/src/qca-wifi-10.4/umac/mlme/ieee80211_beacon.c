                      ...
                      u_int8_t *frm)
{
    ...
    *frm++ = IEEE80211_ELEMID_SSID;
    ...
    if(!(ic->ic_disable_bcn_bwnss_map) && !(ic->ic_disable_bwnss_adv) && !ieee80211_get_bw_nss_mapping(vap, &nssmap, rx_chainmask)) {
        bo->bo_bwnss_map = frm;
                ...
                if (timoff == 128) {
                    ...
                    if (i < timoff) {
                        ...
                        if (timlen > 68) {
                            timoff = 0;
                            timlen = 1;
                            printk("Recover in TIM update Invalid TIM length\n");
                        }
                    }
                }
            } else {
