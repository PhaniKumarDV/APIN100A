...
void DisplayHelp(void)
{
    ...
    if (sa_enable_test_mode) {
        printk(" SMART_ANT_PARAM_BCN_ANTENNA             %d    Beacon Antenna  \n",SMART_ANT_PARAM_BCN_ANTENNA);
        printk(" SMART_ANT_PARAM_TRAIN_RATE_TESTMODE     %d    Training Rate Code in test mode\n",SMART_ANT_PARAM_TRAIN_RATE_TESTMODE);
        printk(" SMART_ANT_PARAM_TRAIN_ANTENNA_TESTMODE  %d    Training Antenna in test mode \n",SMART_ANT_PARAM_TRAIN_ANTENNA_TESTMODE);
        printk(" SMART_ANT_PARAM_TRAIN_PACKETS_TETSMODE  %d    Number of training packets in test mode \n",SMART_ANT_PARAM_TRAIN_PACKETS_TETSMODE);
        printk(" SMART_ANT_PARAM_TRAIN_START_TETSMODE    %d    Training start in test mode  \n",SMART_ANT_PARAM_TRAIN_START_TETSMODE);
    }
}
