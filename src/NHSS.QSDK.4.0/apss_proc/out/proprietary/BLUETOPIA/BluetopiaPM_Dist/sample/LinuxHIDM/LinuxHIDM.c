...
static char *RetrieveKeyDescription(Byte_t KeyIndex)
{
   ...
   if((KeyIndex >= HIDKeyLookupTable[0].Key) && (((Byte_t)(KeyIndex - HIDKeyLookupTable[0].Key)) < (sizeof(HIDKeyLookupTable)/sizeof(HIDKeyLookupTableEntry_t))))
      ret_val = HIDKeyLookupTable[(Byte_t)(KeyIndex - HIDKeyLookupTable[0].Key)].String;
   else
   {
      if((KeyIndex >= HIDSpecialKeyLookupTable[0].Key) && (((Byte_t)(KeyIndex - HIDSpecialKeyLookupTable[0].Key)) < (sizeof(HIDSpecialKeyLookupTable)/sizeof(HIDKeyLookupTableEntry_t))))
         ret_val = HIDSpecialKeyLookupTable[(Byte_t)(KeyIndex - HIDSpecialKeyLookupTable[0].Key)].String;
      else
