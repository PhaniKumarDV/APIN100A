...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  PASSAPI - Stonestreet One Bluetooth Phone Alert Status Service (GATT      */
...
typedef enum
{
   ...
   etPASS_Server_Ringer_Control_Command_Indication
} PASS_Event_Type_t;
...
#define PASS_EVENT_DATA_SIZE                             (sizeof(PASS_Event_Data_t))
   ...
   /* the caller the Bluetooth Stack ID, the PASS Event Data that       */
   /* occurred and the PASS Service Event Callback Parameter that was   */
...
BTPSAPI_DECLARATION unsigned long BTPSAPI PASS_Suspend(unsigned int BluetoothStackID, unsigned long BufferSize, void *Buffer);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef unsigned long (BTPSAPI *PFN_PASS_Suspend_t)(unsigned int BluetoothStackID, unsigned long BufferSize, void *Buffer);
#endif
   ...
   /* PASS_Suspend()).  This function accepts as input the Bluetooth    */
   /* Stack ID of the Bluetooth Stack that the Device is associated     */
   /* with.  The final two parameters are the buffer size and buffer    */
   /* that contains the memory that was used to collapse Bluetopia      */
   /* context into with a successfull call to PASS_Suspend().  This     */
   /* function returns ZERO on success or a negative error code.        */
BTPSAPI_DECLARATION int BTPSAPI PASS_Resume(unsigned int BluetoothStackID, unsigned long BufferSize, void *Buffer);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_PASS_Resume_t)(unsigned int BluetoothStackID, unsigned long BufferSize, void *Buffer);
#endif
