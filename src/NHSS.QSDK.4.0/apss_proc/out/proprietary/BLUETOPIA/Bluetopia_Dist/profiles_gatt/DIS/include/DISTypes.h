...
#define DIS_ASSIGN_DIS_SERVICE_UUID_16(_x)               ASSIGN_BLUETOOTH_UUID_16((_x), 0x18, 0x0A)
...
#define DIS_COMPARE_DIS_SERVICE_UUID_TO_UUID_16(_x)      COMPARE_BLUETOOTH_UUID_16_TO_CONSTANT((_x), 0x18, 0x0A)
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Big-Endian format.                                       */
#define DIS_ASSIGN_DIS_SERVICE_SDP_UUID_16(_x)           ASSIGN_SDP_UUID_16((_x), 0x18, 0x0A)
