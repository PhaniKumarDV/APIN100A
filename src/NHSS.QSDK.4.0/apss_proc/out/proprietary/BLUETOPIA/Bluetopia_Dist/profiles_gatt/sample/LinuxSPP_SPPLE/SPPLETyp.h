...
/******************************************************************************/
#ifndef __SPPLETYPH__
#define __SPPLETYPH__
...
#define SPPLE_ASSIGN_SPPLE_SERVICE_UUID_128(_x)                 ASSIGN_BLUETOOTH_UUID_128((_x), 0x14, 0x83, 0x9A, 0xC4, 0x7D, 0x7E, 0x41, 0x5c, 0x9A, 0x42, 0x16, 0x73, 0x40, 0xCF, 0x23, 0x39)
   ...
   /* than/(greater 4.1) than.  The first parameter is the UUID_128_t variable*/
...
#define SPPLE_ASSIGN_TX_UUID_128(_x)                            ASSIGN_BLUETOOTH_UUID_128((_x), 0x07, 0x34, 0x59, 0x4A, 0xA8, 0xE7, 0x4b, 0x1a, 0xA6, 0xB1, 0xCD, 0x52, 0x43, 0x05, 0x9A, 0x57)
   ...
   /* UUID (MACRO returns boolean result) NOT less than/(greater 4.1) than.   */
...
#define SPPLE_ASSIGN_RX_CREDITS_UUID_128(_x)                    ASSIGN_BLUETOOTH_UUID_128((_x), 0xE0, 0x6D, 0x5E, 0xFB, 0x4F, 0x4A, 0x45, 0xc0, 0x9E, 0xB1, 0x37, 0x1A, 0xE5, 0xA1, 0x4A, 0xD4)
   ...
   /* variable to compare to the SPPLE RX_CREDITS UUID.                 */
