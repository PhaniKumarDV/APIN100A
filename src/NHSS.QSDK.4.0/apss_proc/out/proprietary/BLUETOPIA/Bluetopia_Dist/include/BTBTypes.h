...
typedef __PACKED_STRUCT_BEGIN__ struct _tagDiffie_Hellman_Key_t
{
   Byte_t Diffie_Hellman_Key0;
   Byte_t Diffie_Hellman_Key1;
   Byte_t Diffie_Hellman_Key2;
   Byte_t Diffie_Hellman_Key3;
   Byte_t Diffie_Hellman_Key4;
   Byte_t Diffie_Hellman_Key5;
   Byte_t Diffie_Hellman_Key6;
   Byte_t Diffie_Hellman_Key7;
   Byte_t Diffie_Hellman_Key8;
   Byte_t Diffie_Hellman_Key9;
   Byte_t Diffie_Hellman_Key10;
   Byte_t Diffie_Hellman_Key11;
   Byte_t Diffie_Hellman_Key12;
   Byte_t Diffie_Hellman_Key13;
   Byte_t Diffie_Hellman_Key14;
   Byte_t Diffie_Hellman_Key15;
   Byte_t Diffie_Hellman_Key16;
   Byte_t Diffie_Hellman_Key17;
   Byte_t Diffie_Hellman_Key18;
   Byte_t Diffie_Hellman_Key19;
   Byte_t Diffie_Hellman_Key20;
   Byte_t Diffie_Hellman_Key21;
   Byte_t Diffie_Hellman_Key22;
   Byte_t Diffie_Hellman_Key23;
   Byte_t Diffie_Hellman_Key24;
   Byte_t Diffie_Hellman_Key25;
   Byte_t Diffie_Hellman_Key26;
   Byte_t Diffie_Hellman_Key27;
   Byte_t Diffie_Hellman_Key28;
   Byte_t Diffie_Hellman_Key29;
   Byte_t Diffie_Hellman_Key30;
   Byte_t Diffie_Hellman_Key31;
} __PACKED_STRUCT_END__ Diffie_Hellman_Key_t;

#define DIFFIE_HELLMAN_KEY_SIZE                       (sizeof(Diffie_Hellman_Key_t))

   /* The following type declaration represents the structure of a      */
   /* Public Key Coordinate (Version 4.2).                              */
typedef __PACKED_STRUCT_BEGIN__ struct _tagPublic_Key_Coordinate_t
{
   Byte_t Public_Key_Coordinate0;
   Byte_t Public_Key_Coordinate1;
   Byte_t Public_Key_Coordinate2;
   Byte_t Public_Key_Coordinate3;
   Byte_t Public_Key_Coordinate4;
   Byte_t Public_Key_Coordinate5;
   Byte_t Public_Key_Coordinate6;
   Byte_t Public_Key_Coordinate7;
   Byte_t Public_Key_Coordinate8;
   Byte_t Public_Key_Coordinate9;
   Byte_t Public_Key_Coordinate10;
   Byte_t Public_Key_Coordinate11;
   Byte_t Public_Key_Coordinate12;
   Byte_t Public_Key_Coordinate13;
   Byte_t Public_Key_Coordinate14;
   Byte_t Public_Key_Coordinate15;
   Byte_t Public_Key_Coordinate16;
   Byte_t Public_Key_Coordinate17;
   Byte_t Public_Key_Coordinate18;
   Byte_t Public_Key_Coordinate19;
   Byte_t Public_Key_Coordinate20;
   Byte_t Public_Key_Coordinate21;
   Byte_t Public_Key_Coordinate22;
   Byte_t Public_Key_Coordinate23;
   Byte_t Public_Key_Coordinate24;
   Byte_t Public_Key_Coordinate25;
   Byte_t Public_Key_Coordinate26;
   Byte_t Public_Key_Coordinate27;
   Byte_t Public_Key_Coordinate28;
   Byte_t Public_Key_Coordinate29;
   Byte_t Public_Key_Coordinate30;
   Byte_t Public_Key_Coordinate31;
} __PACKED_STRUCT_END__ Public_Key_Coordinate_t;

#define PUBLIC_KEY_COORDINATE_SIZE                    (sizeof(Public_Key_Coordinate_t))

   /* The following type declaration represents the structure of a      */
   /* P-256 Public Key (Version 4.2).                                   */
typedef __PACKED_STRUCT_BEGIN__ struct _tagP256_Public_Key_t
{
   Public_Key_Coordinate_t X;
   Public_Key_Coordinate_t Y;
} __PACKED_STRUCT_END__ P256_Public_Key_t;

#define P256_PUBLIC_KEY_SIZE                          (sizeof(P256_Public_Key_t))

   /* The following type declaration represents the structure of a P256 */
   /* Private Key (Version 4.2).                                        */
typedef __PACKED_STRUCT_BEGIN__ struct _tagP256_Private_Key_t
{
   Byte_t Private_Key_Byte0;
   Byte_t Private_Key_Byte1;
   Byte_t Private_Key_Byte2;
   Byte_t Private_Key_Byte3;
   Byte_t Private_Key_Byte4;
   Byte_t Private_Key_Byte5;
   Byte_t Private_Key_Byte6;
   Byte_t Private_Key_Byte7;
   Byte_t Private_Key_Byte8;
   Byte_t Private_Key_Byte9;
   Byte_t Private_Key_Byte10;
   Byte_t Private_Key_Byte11;
   Byte_t Private_Key_Byte12;
   Byte_t Private_Key_Byte13;
   Byte_t Private_Key_Byte14;
   Byte_t Private_Key_Byte15;
   Byte_t Private_Key_Byte16;
   Byte_t Private_Key_Byte17;
   Byte_t Private_Key_Byte18;
   Byte_t Private_Key_Byte19;
   Byte_t Private_Key_Byte20;
   Byte_t Private_Key_Byte21;
   Byte_t Private_Key_Byte22;
   Byte_t Private_Key_Byte23;
   Byte_t Private_Key_Byte24;
   Byte_t Private_Key_Byte25;
   Byte_t Private_Key_Byte26;
   Byte_t Private_Key_Byte27;
   Byte_t Private_Key_Byte28;
   Byte_t Private_Key_Byte29;
   Byte_t Private_Key_Byte30;
   Byte_t Private_Key_Byte31;
} __PACKED_STRUCT_END__ P256_Private_Key_t;

#define P256_PRIVATE_KEY_SIZE                         (sizeof(P256_Private_Key_t))

   /* The following type declaration represents the structure of a      */
   /* single Secure Connections Confirmation, C used for OOB mechanism  */
   /* of LE Secure Connections (Version 4.2).                           */
typedef __PACKED_STRUCT_BEGIN__ struct _tagSecure_Connections_Confirmation_t
{
   Byte_t Confirmation0;
   Byte_t Confirmation1;
   Byte_t Confirmation2;
   Byte_t Confirmation3;
   Byte_t Confirmation4;
   Byte_t Confirmation5;
   Byte_t Confirmation6;
   Byte_t Confirmation7;
   Byte_t Confirmation8;
   Byte_t Confirmation9;
   Byte_t Confirmation10;
   Byte_t Confirmation11;
   Byte_t Confirmation12;
   Byte_t Confirmation13;
   Byte_t Confirmation14;
   Byte_t Confirmation15;
} __PACKED_STRUCT_END__ Secure_Connections_Confirmation_t;

#define SECURE_CONNECTIONS_CONFIRMATION_SIZE          (sizeof(Secure_Connections_Confirmation_t))

   /* The following type declaration represents the structure of a      */
   /* single Secure Connections Randomizer, R used for OOB mechanism of */
   /* LE Secure Connections (Version 4.2).                              */
typedef __PACKED_STRUCT_BEGIN__ struct _tagSecure_Connections_Randomizer_t
{
   Byte_t Randomizer0;
   Byte_t Randomizer1;
   Byte_t Randomizer2;
   ...
   Byte_t Randomizer14;
   Byte_t Randomizer15;
} __PACKED_STRUCT_END__ Secure_Connections_Randomizer_t;

#define SECURE_CONNECTIONS_RANDOMIZER_SIZE            (sizeof(Secure_Connections_Randomizer_t))
