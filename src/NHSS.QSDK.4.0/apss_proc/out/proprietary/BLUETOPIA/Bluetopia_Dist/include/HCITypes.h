...
#define HCI_SUPPORTED_COMMAND_LE_READ_LOCAL_P256_PUBLIC_KEY                                     0x0111
#define HCI_SUPPORTED_COMMAND_LE_GENERATE_DH_KEY                                                0x0112
#define HCI_SUPPORTED_COMMAND_LE_ADD_DEVICE_TO_RESOLVING_LIST                                   0x0113
#define HCI_SUPPORTED_COMMAND_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST                              0x0114
#define HCI_SUPPORTED_COMMAND_LE_CLEAR_RESOLVING_LIST                                           0x0115
#define HCI_SUPPORTED_COMMAND_LE_READ_RESOLVING_LIST_SIZE                                       0x0116
#define HCI_SUPPORTED_COMMAND_LE_READ_PEER_RESOLVABLE_ADDRESS                                   0x0117
#define HCI_SUPPORTED_COMMAND_LE_READ_LOCAL_RESOLVABLE_ADDRESS                                  0x0118
#define HCI_SUPPORTED_COMMAND_LE_SET_ADDRESS_RESOLUTION_ENABLE                                  0x0119
#define HCI_SUPPORTED_COMMAND_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT                         0x011A
#define HCI_SUPPORTED_COMMAND_LE_READ_MAXIMUM_DATA_LENGTH                                       0x011B
...
#define HCI_LE_ADVERTISING_ENABLE                                       0x01
   ...
   /* The following constants represent that values that are used to    */
   /* specify the type of Scan to perform while scanning (Version 4.0 + */
   /* LE).                                                              */
...
#define HCI_LE_SCANNING_FILTER_POLICY_ACCEPT_WHITE_LIST_ONLY            0x01
   ...
   /* Policies that are supported by the controllers supporting the LE  */
...
#define HCI_LE_CONNECTION_LATENCY_MAXIMUM                               0x01F3
...
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_LE_SECURE_CONNECTIONS_CONFIRMATION_VALUE   0x22
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_LE_SECURE_CONNECTIONS_RANDOM_VALUE         0x23
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_URI                                        0x24
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_INDOOR_POSITIONING                         0x25
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_TRANSPORT_DISCOVERY                        0x26
#define HCI_LE_ADVERTISING_REPORT_DATA_TYPE_3D_INFORMATION_DATA                        0x3D
