...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  DIDAPI -  Stonestreet One Bluetooth Stack Device Identification Profile   */
...
#define DID_PROFILE_VERSION                        (0x0103)
   ...
   /* The following define the values that can be assigned for the      */
   /* Vendor ID Source.                                                 */
#define DID_VENDOR_ID_SOURCE_BLUETOOTH_SIG         (0x0001)
#define DID_VENDOR_ID_SOURCE_USB_IMPLEMENTER_FORUM (0x0002)
...
typedef struct _tagDID_Info
{
   ...
   /* The following function is responsible for adding a Device         */
   /* Identification SDP Record to the SDP Database.  The first         */
   /* parameter to this function is the Bluetooth Stack ID of the SDP   */
   /* Server to create the SDP Record on.  The second parameter is a    */
   ...
   /* DID_Un_Register_SDP_Record() function.  This function returns a   */
...
BTPSAPI_DECLARATION SDWord_t BTPSAPI DID_Register_SDP_Record(unsigned int BluetoothStackID, DID_Info_t *DeviceIdentificationInfo);
   ...
   /* This function returns zero if the specified Service Record was    */
...
#define DID_Un_Register_SDP_Record(__BluetoothStackID, __SDPRecordHandle) \
   ...
   /* The following function parses an SDP response returned from       */
   /* SDP_Service_Attribute_Request() or                                */
   /* SDP_Service_Search_Attribute_Request().  The first parameter is a */
   /* pointer to the SDP Response Data received from the SDP Event      */
   /* Callback function.  The second parameter is a pointer to a Device */
   ...
   /* set to 0.  This function returns a positive, non-zero, value if   */
