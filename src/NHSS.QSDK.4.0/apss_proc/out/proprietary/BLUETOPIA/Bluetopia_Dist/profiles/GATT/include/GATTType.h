...
#define GATT_COMPARE_CHARACTERISTIC_EXTENDED_PROPERTIES_ATTRIBUTE_TYPE_TO_BLUETOOTH_UUID_16(_x)    COMPARE_BLUETOOTH_UUID_16_TO_CONSTANT((_x), 0x29, 0x00)
   ...
   /* The following defines the GATT Extended Properties UUID that is   */
   /* used when building the service tables.                            */
#define GATT_EXTENDED_PROPERTIES_BLUETOOTH_UUID_CONSTANT                         { 0x00, 0x29 }

   /* The following defines the valid length of the GATT Extended       */
   /* Properties descriptor.                                            */
#define GATT_EXTENDED_PROPERTIES_LENGTH                                          (NON_ALIGNED_WORD_SIZE)
...
#define GATT_COMPARE_CHARACTERISTIC_USER_DESCRIPTION_ATTRIBUTE_TYPE_TO_BLUETOOTH_UUID_16(_x)       COMPARE_BLUETOOTH_UUID_16_TO_CONSTANT((_x), 0x29, 0x01)
   ...
   /* The following defines the GATT User Description UUID that is used */
   /* when building the service tables.                                 */
#define GATT_USER_DESCRIPTION_BLUETOOTH_UUID_CONSTANT                            { 0x01, 0x29 }
