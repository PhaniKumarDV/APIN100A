...
#define AVRCP_PROFILE_VERSION                                        (0x0106)
...
#define AVRCP_PROFILE_VERSION_1_5                                    (0x0105)
#define AVRCP_PROFILE_VERSION_1_6                                    (0x0106)
...
#define AVRCP_PASS_THROUGH_GROUP_NAVIGATION_RESPONSE_DATA_SIZE       (sizeof(AVRCP_Pass_Through_Group_Navigation_Response_Data_t))
   ...
   /* AVRCP values.                                                     */
#define AVRCP_PASS_THROUGH_VENDOR_UNIQUE_ID_NEXT_GROUP               (0x0000)
#define AVRCP_PASS_THROUGH_VENDOR_UNIQUE_ID_PREVIOUS_GROUP           (0x0001)
...
#define AVRCP_SPECIFIC_AV_C_COMMAND_PDU_ID_GET_TOTAL_NUMBER_OF_ITEMS                (0x75)
...
#define AVRCP_GENERAL_REJECT_RESPONSE_PDU_SIZE                       (sizeof(AVRCP_General_Reject_Response_PDU_t))
   ...
   /* The following type definition defines the structure of a Get      */
   /* Total Number of Items Command PDU (AVRCP Specific AV/C Browsing   */
   /* Command).                                                         */
typedef __PACKED_STRUCT_BEGIN__ struct _tagAVRCP_Get_Total_Number_Of_Items_Command_PDU_t
{
   AVRCP_Specific_AV_C_Browsing_Command_Header_t AVRCP_Specific_AV_C_Browsing_Command_Header;
   Byte_t                                        Scope;
} __PACKED_STRUCT_END__ AVRCP_Get_Total_Number_Of_Items_Command_PDU_t;

#define AVRCP_GET_TOTAL_NUMBER_OF_ITEMS_COMMAND_PDU_SIZE             (sizeof(AVRCP_Get_Total_Number_Of_Items_Command_PDU_t))

   /* The following type definition defines the structure of a Get      */
   /* Total Number of Items Response PDU (AVRCP Specific AV/C Browsing  */
   /* Response).                                                        */
typedef __PACKED_STRUCT_BEGIN__ struct _tagAVRCP_Get_Total_Number_Od_Items_Response_PDU_t
{
   AVRCP_Specific_AV_C_Browsing_Response_Header_t AVRCP_Specific_AV_C_Browsing_Response_Header;
   Byte_t                                         Status;
   NonAlignedWord_t                               UIDCounter;
   NonAlignedDWord_t                              NumberItems;
} __PACKED_STRUCT_END__ AVRCP_Get_Total_Number_Of_Items_Response_PDU_t;

#define AVRCP_GET_TOTAL_NUMBER_OF_ITEMS_RESPONSE_PDU_SIZE            (sizeof(AVRCP_Get_Total_Number_Of_Items_Response_PDU_t))
