...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  A2DPAPI - Stonestreet One Bluetooth Stack Advanced Audio Distribution     */
...
#define A2DP_PROFILE_VERSION                                            (0x0103)

   /* The following constants define the previous Profile Versions of   */
   /* the Advanced Audio Distribution Profile that are supported by this*/
   /* implementation.  These values can be used in the SDP Records to   */
   /* specify a specific A2DP Version.                                  */
#define A2DP_PROFILE_VERSION_1_0                                        (0x0100)
#define A2DP_PROFILE_VERSION_1_2                                        (0x0102)
#define A2DP_PROFILE_VERSION_1_3                                        (0x0103)

   /* The following enumerated type is provided to allow application    */
   /* developers an easy to use enumerated type to reference supported  */
   /* A2DP versions.  It is NOT used anywhere else in this API and is   */
   /* provided as an application aid.                                   */
typedef enum
{
   advVersion1_0,
   advVersion1_2,
   ...
   /* Transmission Unit) that is allowed by this profile.               */
#define A2DP_MINIMUM_L2CA_MTU                                           (335)
...
#define A2DP_GAVD_ERROR_CODE_INVALID_CODEC_PARAMETER                    (0xE2)
#define A2DP_GAVD_ERROR_CODE_NOT_SUPPORTED_CODEC_PARAMETER              (0xE3)
...
#define A2DP_SBC_READ_SAMPLING_FREQUENCY(_x)                            (((A2DP_SBC_Codec_Specific_Information_Element_t *)(_x))->SamplingFrequencyChannelMode & A2DP_SBC_SAMPLING_FREQUENCY_MASK)
   ...
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual channel mode value to store into   */
...
#define A2DP_SBC_READ_CHANNEL_MODE(_x)                                  (((A2DP_SBC_Codec_Specific_Information_Element_t *)(_x))->SamplingFrequencyChannelMode & A2DP_SBC_CHANNEL_MODE_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual block length value to store into   */
   /* the Codec Specific Information Element structure.                 */
...
#define A2DP_SBC_READ_BLOCK_LENGTH(_x)                                  (((A2DP_SBC_Codec_Specific_Information_Element_t *)(_x))->BlockLengthSubbandsAllocationMethod & A2DP_SBC_BLOCK_LENGTH_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual subbands value to store into the   */
...
#define A2DP_MPEG_1_2_BIT_RATE_INDEX_0000_VALUE                         (0x0001)
   ...
   /* the Codec Specific Information Element structure.  The second     */
   /* parameter is the actual layer value to store into the Codec       */
...
#define A2DP_MPEG_1_2_READ_LAYER(_x)                                    (((A2DP_MPEG_1_2_Codec_Specific_Information_Element_t *)(_x))->LayerCRCChannelMode & A2DP_MPEG_1_2_LAYER_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual CRC protection value to store into */
   /* the Codec Specific Information Element structure.                 */
...
#define A2DP_MPEG_1_2_READ_VARIABLE_BIT_RATE_SUPPORT(_x)                (((A2DP_MPEG_1_2_Codec_Specific_Information_Element_t *)(_x))->VBRBitRate & A2DP_MPEG_1_2_VARIABLE_BIT_RATE_SUPPORT_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual variable bit rate index value to   */
...
#define A2DP_MPEG_2_4_BIT_RATE_LOWER_BYTE_MASK                          (0xFF)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual object type value to store into the*/
   /* Codec Specific Information Element structure.                     */
...
#define A2DP_MPEG_2_4_READ_SAMPLING_FREQUENCY(_x)                       ((Word_t)(((Word_t)(((A2DP_MPEG_2_4_Codec_Specific_Information_Element_t *)(_x))->SamplingFrequency & A2DP_MPEG_2_4_SAMPLING_FREQUENCY_UPPER_BYTE_MASK) << 8) | (Word_t)(((A2DP_MPEG_2_4_Codec_Specific_Information_Element_t *)(_x))->SamplingFrequencyChannelsRFA & A2DP_MPEG_2_4_SAMPLING_FREQUENCY_LOWER_BYTE_MASK)))
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual channels value to store into the   */
   /* Codec Specific Information Element structure.                     */
...
#define A2DP_MPEG_2_4_READ_VARIABLE_BIT_RATE_SUPPORT(_x)                (((A2DP_MPEG_2_4_Codec_Specific_Information_Element_t *)(_x))->VBRBitRate & A2DP_MPEG_2_4_VARIABLE_BIT_RATE_SUPPORT_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual bit rate value to store into the   */
   /* Codec Specific Information Element structure.                     */
...
#define A2DP_ATRAC_MAXIMUM_SUL_LOWER_BYTE_MASK                          (0xFF)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual version value to store into the    */
   /* Codec Specific Information Element structure.                     */
...
#define A2DP_ATRAC_READ_VARIABLE_BIT_RATE_SUPPORT(_x)                   (((A2DP_ATRAC_Codec_Specific_Information_Element_t *)(_x))->RFASamplingFrequencyVBRBitRate & A2DP_ATRAC_VARIABLE_BIT_RATE_SUPPORT_MASK)
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual bit rate index value to store into */
   /* the Codec Specific Information Element structure.                 */
...
#define A2DP_ATRAC_READ_BIT_RATE_INDEX(_x)                              ((DWord_t)(((DWord_t)(((A2DP_ATARC_Codec_Specific_Information_Element_t *)(_x))->RFASamplingFrequencyVBRBitRate & A2DP_ATRAC_BIT_RATE_UPPER_BYTE_MASK) << 16) | ((DWord_t)(((A2DP_ATRAC_Codec_Specific_Information_Element_t *)(_x))->BitRate0 & A2DP_ATRAC_BIT_RATE_MIDDLE_BYTE_MASK) << 8) | (((A2DP_ATRAC_Codec_Specific_Information_Element_t *)(_x))->BitRate1 & A2DP_ATRAC_BIT_RATE_LOWER_BYTE_MASK)))
   ...
   /* Element variable.  This MACRO accepts as it's first parameter a   */
   /* pointer to the Codec Specific Information Element structure.  The */
   /* second parameter is the actual maximum SUL value to store into the*/
   /* Codec Specific Information Element structure.                     */
...
#define A2DP_ATRAC_READ_MAXIMUM_SUL(_x)                                 ((Word_t)(((Word_t)(((A2DP_ATRAC_Codec_Specific_Information_Element_t *)(_x))->MaximumSUL0) << 8) | (((A2DP_ATRAC_Codec_Specific_Information_Element_t *)(_x))->MaximumSUL1)))
   ...
   /* Non A2DP Media Codec Type Definitions/Constants.                  */

   /* The following structure represents the Codec Specific Information */
   /* Element for a generic non A2DP media codec (i.e.  vendor defined).*/
typedef __PACKED_STRUCT_BEGIN__ struct _tagA2DP_Non_A2DP_Codec_Specific_Information_Element_t
{
   NonAlignedDWord_t VendorID;
   NonAlignedWord_t  VendorSpecificCodecID;
   Byte_t            VendorSpecificValue[1];
} __PACKED_STRUCT_END__ A2DP_Non_A2DP_Codec_Specific_Information_Element_t;

   /* The following MACRO is provided to allow the programmer a very    */
   /* simple means of quickly determining the number of bytes that will */
   /* be required to hold an entire non A2DP Codec Specific Information */
   /* Element of the specified length (number of bytes contained in     */
   /* VendorSpecificValue member).                                      */
#define A2DP_NON_A2DP_CODEC_SPECIFIC_INFORMATION_ELEMENT_SIZE(_x)       (sizeof(A2DP_Non_A2DP_Codec_Specific_Information_Element_t) - sizeof(unsigned char) + (unsigned int)(_x))

   /* The following MACRO is a utility MACRO that exists to assign the  */
   /* Vendor ID value into the specified Non A2DP Codec Specific        */
   /* Information Element variable.  This MACRO accepts as it's first   */
   /* parameter a pointer to the Non A2DP Codec Specific Information    */
   /* Element structure.  The second parameter is the actual Vendor ID  */
   /* value to store into the Non A2DP Codec Specific Information       */
   /* Element structure.                                                */
#define A2DP_NON_A2DP_CODEC_ASSIGN_VENDOR_ID(_x, _y)                    ASSIGN_HOST_DWORD_TO_LITTLE_ENDIAN_UNALIGNED_DWORD(&(((A2DP_Non_A2DP_Codec_Specific_Information_Element_t *)(_x))->VendorID), ((DWord_t)_y))

   /* The following MACRO is a utility MACRO that exists to read the    */
   /* Vendor ID value from the specified Non A2DP Codec Specific        */
   /* Information Element variable.  This MACRO accepts as its only     */
   /* parameter a pointer to the Non A2DP Codec Specific Information    */
   /* Element structure.  This MACRO returns the Vendor ID value.       */
#define A2DP_NON_A2DP_CODEC_READ_VENDOR_ID(_x)                          ((DWord_t)READ_UNALIGNED_DWORD_LITTLE_ENDIAN(&(((A2DP_Non_A2DP_Codec_Specific_Information_Element_t *)(_x))->VendorID)))

   /* The following MACRO is a utility MACRO that exists to assign the  */
   /* Vendor Specific Codec ID value into the specified Non A2DP Codec  */
   /* Specific Information Element variable.  This MACRO accepts as it's*/
   /* first parameter a pointer to the Non A2DP Codec Specific          */
   /* Information Element structure.  The second parameter is the actual*/
   /* Vendor Specific Codec ID value to store into the Non A2DP Codec   */
   /* Specific Information Element structure.                           */
#define A2DP_NON_A2DP_CODEC_ASSIGN_VENDOR_CODEC_ID(_x, _y)              ASSIGN_HOST_WORD_TO_LITTLE_ENDIAN_UNALIGNED_WORD(&(((A2DP_Non_A2DP_Codec_Specific_Information_Element_t *)(_x))->VendorSpecificCodecID), ((Word_t)_y))

   /* The following MACRO is a utility MACRO that exists to read the    */
   /* Vendor Specific Codec ID value from the specified Non A2DP Codec  */
   /* Specific Information Element variable.  This MACRO accepts as its */
   /* only parameter a pointer to the Non A2DP Codec Specific           */
   /* Information Element structure.  This MACRO returns the Non A2DP   */
   /* Vendor Codec ID value.                                            */
#define A2DP_NON_A2DP_CODEC_READ_VENDOR_CODEC_ID(_x)                    ((Word_t)READ_UNALIGNED_WORD_LITTLE_ENDIAN(&(((A2DP_Non_A2DP_Codec_Specific_Information_Element_t *)(_x))->VendorSpecificCodecID)))

   /* APT-X (Non A2DP Media Codec) Type Definitions/Constants.          */

   /* The following constant represents the Vendor ID value of the APT-X*/
   /* Codec.                                                            */
#define A2DP_NON_A2DP_CODEC_APTX_VENDOR_ID                              (HCI_LMP_COMPID_MANUFACTURER_NAME_APT_LIMITED)

   /* The following constant represents the Vendor ID value of the APT-X*/
   /* Codec ID.                                                         */
#define A2DP_NON_A2DP_CODEC_APTX_VENDOR_CODEC_ID                        0x0001

   /* The following structure represents the Codec Specific Information */
   /* Element for the APT-X Non A2DP Media Codec.                       */
   /* * NOTE * This is the format of the VendorSpecificValue member of  */
   /*          the A2DP_Non_A2DP_Codec_Specific_Information_Element_t   */
   /*          that specifies the APT-X Media Codec Specific            */
   /*          Information.                                             */
typedef __PACKED_STRUCT_BEGIN__ struct _tagA2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_t
{
   Byte_t SamplingFrequencyChannelMode;
} __PACKED_STRUCT_END__ A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_t;

#define A2DP_NON_A2DP_CODEC_APTX_CODEC_SPECIFIC_INFORMATION_SIZE        (sizeof(A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_t))

   /* The following structure represents the format of an APT-X Codec   */
   /* Specific Information Element.                                     */
   /* * NOTE * This structure is simply the Non A2DP Codec Vendor       */
   /*          Specific Information Element and the APT-X Codec Specific*/
   /*          Information.                                             */
typedef __PACKED_STRUCT_BEGIN__ struct _tagA2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t
{
   NonAlignedDWord_t                                     VendorID;
   NonAlignedWord_t                                      VendorSpecificCodecID;
   A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_t CodecSpecificInformation;
} __PACKED_STRUCT_END__ A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t;

#define A2DP_NON_A2DP_CODEC_APTX_CODEC_SPECIFIC_INFORMATION_ELEMENT_SIZE   (sizeof(A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t))

   /* The following constants represent the defined sampling frequencies*/
   /* supported by the APT-X codec.  These values are as they would     */
   /* appear in Octet0 of the Vendor Specific Codec Information.        */
#define A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_MASK                (0xF0)
#define A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_16_KHZ_VALUE        (0x80)
#define A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_32_KHZ_VALUE        (0x40)
#define A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_44_1_KHZ_VALUE      (0x20)
#define A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_48_KHZ_VALUE        (0x10)

   /* The following constants represent the defined channel modes       */
   /* supported by the subband codec.  These values are as they would   */
   /* appear in Octet0 of the Codec Specific Information Element for the*/
   /* subbands codec.                                                   */
#define A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_MASK                      (0x0F)
#define A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_MONO_VALUE                (0x08)
#define A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_DUAL_CHANNEL_VALUE        (0x04)
#define A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_STEREO_VALUE              (0x02)
#define A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_JOINT_STEREO_VALUE        (0x01)

   /* The following MACRO is a utility MACRO that exists to assign the  */
   /* sampling frequency value into the specified APT-X Codec Specific  */
   /* Information Element variable.  This MACRO accepts as it's first   */
   /* parameter a pointer to the APT-X Codec Specific Information       */
   /* Element structure.  The second parameter is the actual sampling   */
   /* frequency value to store into the APT-X Codec Specific Information*/
   /* Element structure.                                                */
#define A2DP_NON_A2DP_CODEC_APTX_ASSIGN_SAMPLING_FREQUENCY(_x, _y)      (((A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t *)(_x))->CodecSpecificInformation.SamplingFrequencyChannelMode |= (Byte_t)((Byte_t)(_y) & A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_MASK))

   /* The following MACRO is a utility MACRO that exists to read the    */
   /* sampling frequency value from the specified APT-X Codec Specific  */
   /* Information Element variable.  This MACRO accepts as its only     */
   /* parameter a pointer to the APT-X Codec Specific Information       */
   /* Element structure.  This MACRO returns the sampling frequency     */
   /* value.                                                            */
#define A2DP_NON_A2DP_CODEC_APTX_READ_SAMPLING_FREQUENCY(_x)            (((A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t *)(_x))->CodecSpecificInformation.SamplingFrequencyChannelMode & A2DP_NON_A2DP_CODEC_APTX_SAMPLING_FREQUENCY_MASK)

   /* The following MACRO is a utility MACRO that exists to assign the  */
   /* channel mode value into the specified APT-X Codec Specific        */
   /* Information Element variable.  This MACRO accepts as it's first   */
   /* parameter a pointer to the APT-X Codec Specific Information       */
   /* Element structure.  The second parameter is the actual channel    */
   /* mode value to store into the APT-X Codec Specific Information     */
   /* Element structure.                                                */
#define A2DP_NON_A2DP_CODEC_APTX_ASSIGN_CHANNEL_MODE(_x, _y)            (((A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t *)(_x))->CodecSpecificInformation.SamplingFrequencyChannelMode |= (Byte_t)((Byte_t)(_y) & A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_MASK))

   /* The following MACRO is a utility MACRO that exists to read the    */
   /* channel mode value from the specified APT-X Codec Specific        */
   /* Information Element variable.  This MACRO accepts as its only     */
   /* parameter a pointer to the APT-X Codec Specific Information       */
   /* Element structure.  This MACRO returns the channel mode value.    */
#define A2DP_NON_A2DP_CODEC_APTX_READ_CHANNEL_MODE(_x)                  (((A2DP_Non_A2DP_Codec_APTX_Codec_Specific_Information_Element_t *)(_x))->CodecSpecificInformation.SamplingFrequencyChannelMode & A2DP_NON_A2DP_CODEC_APTX_CHANNEL_MODE_MASK)
