...
-------------------------------------------------------------------------------
  ...
  $Header: //depot/asic/ipq8066/IPQ8064.ILQ.4.1/meta/main/latest/common/build/update_common_info.py#5 $
  $DateTime: 2016/10/03 03:10:20 $
...
if FIT_tool:
   ...
   os.rename("./ipq/nor-system-partition-v2.bin", "./ipq/nor-system-partition.bin")
   ...
   os.rename("./ipq/openwrt-ipq806x-qcom-ipq8064-ap148-ubi-root.img", "./ipq/ipq806x-ubi-root.img")
   os.rename("./ipq/openwrt-ipq806x-qcom-ipq8064-ap148-fit-uImage.itb", "./ipq/qca_ipq806x_ap.akxx.itb")
