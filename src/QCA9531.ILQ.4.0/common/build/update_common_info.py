...
-------------------------------------------------------------------------------
  ...
  $Header: //source/qcom/qct/tools/meta/00/01/common/build/update_common_info.py#18 $
  $DateTime: 2013/08/03 01:41:43 $
...
if FIT_tool:
   ...
   lg.log_exec(['python',pack_tool,'-i','-p','2048','-b','64','-t','nand','-o',bin_dir +'/'+'ipq806x-single.img',ipq_dir],verbose=0)
