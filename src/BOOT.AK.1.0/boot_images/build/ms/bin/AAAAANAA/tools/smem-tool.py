...
type_info_list = OrderedDict([
    ...
    ("SMEM_BOOT_FLASH_TYPE", tinfo(421)),
    ("SMEM_BOOT_FLASH_INDEX", tinfo(422)),
    ("SMEM_BOOT_FLASH_CHIP_SELECT", tinfo(423)),
    ("SMEM_BOOT_FLASH_BLOCK_SIZE", tinfo(424)),
    ("SMEM_MACHID_INFO_LOCATION", tinfo(425))
])
